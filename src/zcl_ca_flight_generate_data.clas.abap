CLASS zcl_ca_flight_generate_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_ca_flight_generate_data IMPLEMENTATION.
...
*   clear data
    DELETE FROM zdb_flight_td.

    "insert travel demo data
    INSERT zdb_flight_td  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table ZDB_FLIGHT_TD. | ).
  ENDMETHOD.
ENDCLASS.
